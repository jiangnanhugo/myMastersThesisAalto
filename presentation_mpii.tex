...
\begin{columns}       
    ...
    \begin{figure}[thp]
      ...
      \begin{tabular}{|l|c|c|}
        ...
        \textbf{\scriptsize\em \#1:} \scriptsize a young boy holding a kite in a park  & -6.31 &\bf 0.80 \\\hline
        ...
        \textbf{\scriptsize\em \#5:} \scriptsize a woman holding a kite in a park      &\bf-6.19 & 0.74 \\\hline
...
\begin{itemize}
    \item<1-> How to use the two input channels: \emph{init} and \emph{persist}?
       \begin{itemize}
           ...
           \item<3-> Best results when \emph{gCNN} is input in \emph{persist} 
       \end{itemize}
    \item<1-> Which image features perform best ?
       \begin{itemize}
           \item<4-> \emph{FRC80} is much better than \emph{SVM80}
           \item<5-> Counterintuitively, localization features don't help much 
           \item<6-> Best model: \textbf{\emph{init}} = \emph{3+3Gauss$\oplus$SUN397$\oplus$FRC80}\\ \textbf{\emph{persist}} = \emph{gCNN}
       \end{itemize}
\end{itemize}
\end{frame}
%%-----------------------------------------------------------------------------
...
\begin{itemize}
    \item How does depth affect the performance ?
       \begin{itemize}
           \item<2-> 2/3 layers increases performance as per metrics moderately, perplexity is worse!
           \item<3-> Residual connections improve perplexity and convergence speed greatly 
           \only<3>{\hspace{-10mm}\begin{figure}[h]
                \centering
