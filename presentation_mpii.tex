...
\begin{table}[t]
  ...
  \begin{tabular}{|l|c|c|c|}
   ...
   Baseline & -- & -- & --\\\hline 
   Addtional Input Channel  & \green{+4.3\%} & \green{-1.7\%} & \green{+5.1\%} \\\hline 
   Object and Scene Dection & \green{+6.4\%} & \green{-2.0\%} & \green{+1.4\%}\\\hline 
   Location Dection         & \green{+0.3\%} & \green{-1.2\%} & \red{-0.1\%} \\\hline 
   Depth (3 layers)         & \green{+0.73\%}& \red{+4.1\%}   & \green{+5.76\%}\\\hline 
   Depth + Residual         & \green{+1.6\%} & \green{-2.2\%} & \green{+3.8\%}\\\hline 
   Evaluator & \green{+0.6\%}& -- & \green{+10.29\%}\\\hline\hline
