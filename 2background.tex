...
Some simple motivation and a set up for the rest of the chapter
...
\section{Natural language modelling and generation}
%%----------------------------------%%
...
%%----------------------------------%%
\section{Recent Literature on Captioning}
%%----------------------------------%%
...
\fixme{Upto a page, mostly fresh writing, but parts can be taken from previous
papers}
%%===========================================================================%%
