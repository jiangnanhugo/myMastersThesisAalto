...
\begin{itemize}
  \item Two different approaches:
      ...
      \end{enumerate}
  \item<2-> Earliest works were retrieval based
          {\begin{itemize}
...
\begin{itemize}
    \item How does depth affect the performance ?
       \begin{itemize}
           ...
           \only<5>{\hspace{-10mm}\begin{figure}[h]
                \centering
    ...
    \item Benefits of Ensembling  
       \begin{itemize}
        \item<8-> CNN evaluator improves the performance moderately  
        \item<9-> Caption diversity is greatly improved 
       \end{itemize}
\end{itemize}
\end{frame}
%%-----------------------------------------------------------------------------
